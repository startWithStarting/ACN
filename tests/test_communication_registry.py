...
# not landed in Phase 0. Compiling them must raise NotImplementedError.
UNIMPLEMENTED_SCHEMES = ("one_hop_direct", "one_hop_mean", "multihop_relay", "multihop_gnn")
...
class TestPlannedSchemes(unittest.TestCase):
    ...
    def test_unimplemented_named_schemes_raise_not_implemented(self):
        """one_hop_direct/one_hop_mean/multihop_relay/multihop_gnn are Phase 1+."""
