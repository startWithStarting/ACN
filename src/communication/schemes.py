"""Built-in communication scheme builders (Phases 1 and 3).
...
per movement step. Phase 3 delivers ``multihop_relay``: the same topology
and transport with the first-seen unchanged-relay processor
(:mod:`src.communication.processors.relay`).
...
__all__ = ["build_one_hop_direct", "build_multihop_relay"]
